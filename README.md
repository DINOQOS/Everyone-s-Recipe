...
- 김윤성
    ...
    3. annotation에 대한 이해가 조금 부족했는데, 팀원들의 도움으로 annotation의 용어들과 개념을 꺠달았고 나아가 컨트롤러와 서비스의 로직들을 많이 작성하여 좋아요, 싫어요 , 조회수, 랭킹등 주요 기능추가에 성공하였습니다.
    ...
    마치며 같이 팀협업에 있어서  github의 효율성을 크게 느꼈고, 어려운게 있으면 혼자가아닌 팀원들과 함께 고민하고해결했던 좋은 프로젝트 였습니다.
...
- 장정우
- 
Springboot에 대한 이해도가 굉장히 낮은상태에서 시작했습니다. 많이 부족했지만, 팀원들과 함께 귀찮아 하지 않고 내 일처럼 모두 함께 도우며 개발하여 구현들을 성공하였습니다.
